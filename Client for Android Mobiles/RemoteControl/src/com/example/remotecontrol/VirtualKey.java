...
public class VirtualKey {
	...
	/**
	 * Stores the state of native event dispatching system - true, if when the
	 * event was created event proxying mechanism was active - false, if it was
	 * inactive Used in Component.dispatchEventImpl to correctly dispatch events
	...
	/*
	 * replaced by VK_KANA_LOCK for Microsoft Windows and Solaris; might still
