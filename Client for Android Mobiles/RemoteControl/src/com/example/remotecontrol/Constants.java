...
public class Constants {
	...
	public static int TouchClickTimeInMS = 150;
	public static boolean horizontalKeyboard = true;
	public static float keyboardZoomLevel = 1;
	public static long keyboardPressDelay = 200;
	public static boolean repeatingKeyEnabled = false;
	...
	public static final String SHARED_PREFERRENCE_NAME = "settings";

	public static void initKeyboardMap() {
		...
		// keyboardMap.put(VirtualKey.VK_RIGHT_SHIFT, new Rect(486, 200,
		// 575,236));
		...
		// keyboardMap.put(VirtualKey.VK_RIGHT_WINDOWS, new Rect(424,
		// 240,468,272));
		keyboardMap.put(VirtualKey.VK_CONTEXT_MENU,
				new Rect(474, 240, 520, 272));
	...
	public static void scaleKeyboardMap() {
		initKeyboardMap();
		for (Integer i : Constants.keyboardMap.keySet()) {
			Rect rect = Constants.keyboardMap.get(i);
			rect.left *= Constants.keyboardZoomLevel;
			rect.top *= Constants.keyboardZoomLevel;
			rect.right *= Constants.keyboardZoomLevel;
			rect.bottom *= Constants.keyboardZoomLevel;
		}
	}
}
